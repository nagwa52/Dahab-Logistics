                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="dropdown show">
                                                <a class="dropdown-toggle text-white text-uppercase" href="../Logistic/about.php" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                               <span class="flag-icon flag-icon-us margin-right-8px"></span> English
                                                   ...
                                                   <div class="dropdown-menu text-small text-uppercase" aria-labelledby="dropdownMenuLink">
                                                    <a class="dropdown-item" href="arabic_logistic/about.php">
            ...
            <div class="row">
                <div class="col-lg-6 sm-mb-45px">
                    ...
                    <div class="about-text margin-tb-25px">
                       ...
                       we are taking full care of customers Trucks’ inside & outside our Service Center, and supply them with full accurate data about their trucks.
                        <br> 
                    </div>
                    <a href="contact.php" class="nile-bottom sm">Contact Us</a>
