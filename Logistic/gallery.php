                            ...
                            <div class="row">
                                <div class="col-xl-8 col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4"><i class="fa fa-envelope-o margin-right-10px"></i><a style="color:white" href="mailto:dahablogs@gmail.com/">dahablogs@gmail.com</a> </div>                                        <div class="col-md-4"><i class="fa fa-map-marker margin-right-10px"></i> 13 batlaymous Street, Alexandria</div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="dropdown show">
                                                <a class="dropdown-toggle text-white text-uppercase" href="../Logistic/gallery.php" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                               <span class="flag-icon flag-icon-us margin-right-8px"></span> English
                                                   ...
                                                   <div class="dropdown-menu text-small text-uppercase" aria-labelledby="dropdownMenuLink">
                                                    <a class="dropdown-item" href="arabic_logistic/gallery.php">
		...
		<div class="container">
			...
			<div class="row margin-bottom-40px">
				...
				<div class="col-lg-4 col-md-6 sm-mb-35px">
					<div class="blog-item">
						<div class="img">
							<a href="#"><img src="assets/img/jumbo/img-4.png" alt=""></a>
						</div>
				...
				<div class="col-lg-4 col-md-6 sm-mb-35px">
					<div class="blog-item">
						<div class="img">
							<a href="#"><img src="assets/img/3adi/img-3.png" alt=""></a>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 sm-mb-35px">
					<div class="blog-item">
						<div class="img">
							<a href="#"><img src="assets/img/kasahat/img-1.png" alt=""></a>
							<!-- <a href="#"><img src="assets/img/kasahat/2962.jpg" alt=""></a> -->
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 sm-mb-35px">
					<div class="blog-item">
						<div class="img">
						 <a href="#"><img src="assets/img/kasahat/img-2.png" alt=""></a>
						</div>
				...
				<div class="col-lg-4 col-md-6 sm-mb-35px">
					<div class="blog-item">
						<div class="img">
						    <a href="#"><img src="assets/img/3adi/img-4.png" alt=""></a>
							</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 sm-mb-35px">
					<div class="blog-item">
						<div class="img">
							<a href="#"><img src="assets/img/dababa/img-6.png" alt=""></a>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<!-- <div class="row">
				<div class="col-lg-6 sm-mb-45px">
					<div class="background-white thum-hover box-shadow hvr-float full-width wow fadeInUp">
						...
						<div class="padding-25px">
							...
							<span class="margin-right-20px text-extra-small"><i class="fa fa-user text-grey-2"></i> By : <a href="#"> Rabie Elkheir</a></span>
							<span class="text-extra-small d-block d-sm-none"><i class="fa fa-clock text-grey-2"></i> Date :  <a href="#"> July 15, 2016</a></span>
						</div>
				...
				<div class="col-lg-6 sm-mb-45px">
					<div class="background-white thum-hover box-shadow hvr-float full-width wow fadeInUp">
						<div class="float-md-left margin-right-30px thum-xs">
							<img src="assets/img/jumbo/img-4.png" alt="">
						</div>
						<div class="padding-25px">
							<i class="fa fa-folder-open text-main-color"></i>
							<a href="#" class="text-main-color">News </a> ,
