                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="dropdown show">
                                                <a class="dropdown-toggle text-white text-uppercase" href="../Logistic/services.php" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                               <span class="flag-icon flag-icon-us margin-right-8px"></span> English
                                                   ...
                                                   <div class="dropdown-menu text-small text-uppercase" aria-labelledby="dropdownMenuLink">
                                                    <a class="dropdown-item" href="arabic_logistic/services.php">
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-9">
					...
					<div class="post-standard">
						...
						<div class="meta-out">
							<ul class="meta">
								<li> <span class="icon icon_clock_alt"></span> May 22, 2018 </li>
								<li> <span class="icon icon_profile"></span><a href="#">Rabie Eltgani</a> </li>
						...
						<a href="#" class="nile-bottom md">Read More <i class="fa fa-arrow-right"></i> </a>
					</div>
